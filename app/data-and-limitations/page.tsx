  ...
  return (
    <main id="main-content" className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <header className="mt-10">
        <p className="text-sm font-medium text-muted-foreground">About MF OS data</p>
        <h1 className="mt-3 font-heading text-3xl font-semibold tracking-tight sm:text-5xl">
          Data and limitations
        </h1>
        <p className="mt-4 max-w-2xl text-base leading-7 text-muted-foreground">
          MF OS is a research tool for exploring Indian equity mutual funds. It does not provide
      ...
      <div className="mt-10 flex flex-col gap-10 text-sm leading-6 text-muted-foreground">
        <section>
          ...
          <p className="mt-3">
            MF OS covers active Direct Growth schemes in supported equity categories. You can view
        ...
        <section>
          ...
          <p className="mt-3">
            A benchmark chart appears only when MF OS has a verified total-return history for the
          ...
          <p className="mt-3">
            ...
            is available, MF OS shows it alongside the portfolio; otherwise it identifies that the
        ...
        <section>
          ...
          <p className="mt-3">
            MF OS does not provide ratings, rankings, recommendations, portfolio-overlap analysis,
